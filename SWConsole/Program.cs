...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        //info print function
        void printWeapon(int selectindex)
        {
            Console.WriteLine(Shop[selectindex].Name + ", Cost: " + Shop[selectindex].PurchaseCost + ", Ranges:");
            foreach (var range in Shop[selectindex].Ranges)
            {
                Console.WriteLine("Range: " + range.Distance + ", Effectiveness: " + range.Effectiveness);
            }

        }

        int getFarthestRange()
        {
            foreach (var weapon in Shop)
            {
            ...
            throw new Exception("Couldn't find the weapon or the range");
            return 0;
        }
